...
echo Title::htmlTitle("Student Page");
echo HomeHeader::homeBanner("<h5>"."<a href='studentGrades.php'> GRADES</a>". "</h5>","<h5>"."<a href='#'> NOTICE </a>". "</h5>","<h5 title='you are here'>" .$nowUser->getStudentUserName() . "</h5>");
